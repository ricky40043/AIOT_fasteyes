...
from app.server.fasteyes_device.crud import check_fasteyes_device_owner, get_fasteyes_device_by_id


def check_FasteyesDevice_Authority(db: Session, current_user: user, device_id: int):
